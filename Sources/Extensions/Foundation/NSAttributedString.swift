...
public extension NSAttributedString {
    /// Returns an NSAttributedString object initialized with HTML-format string.
    ///
    /// - Parameter htmlString: HTML-format string.
    public convenience init(from htmlString: String) throws {
        try self.init(
